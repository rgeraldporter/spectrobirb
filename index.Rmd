...
png("fee%04d.png", res = 240, width = 3840, height = 2160)
...
```{r}
system("ffmpeg -framerate 60 -i fee%04d.png -c:v libx264 -profile:v high -crf 2 -pix_fmt yuv420p spectro_movie.mp4")
```
